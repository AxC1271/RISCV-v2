...
- **The properties themselves get harder to state.** "Does `res` equal the ISA-defined result for
  ...
  what individual formal proofs (see `../formal_verification/`) are for.
...
a large input space get formally verified in `../formal_verification/` (see that folder's README
